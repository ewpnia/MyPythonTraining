...
>>> sort_aa = sorted(aa.iteritems(),key=itemgetter(1))
>>> sort_aa
...
>>> sort_aa = sorted(aa.iteritems(), key=lambda dct:dct[1])
>>> sort_aa
[('a', '1'), ('sss', '2'), ('ffff2', '3'), ('ffdf', '5')]

>>> sort_aa = sorted(aa.iteritems(), key=lambda dct:dct[0])
>>> sort_aa
...
# 在Python中提供了getopt模块很好的实现了命令行参数的解析
